...
angular.module('bayesThornApp')
  .controller('MapController', ["$scope", "dataFetcher", "$timeout", function ($scope, dataFetcher, $timeout) {
    ...
    var p2 = dataFetcher.getData2('./data/AggregatedData.json');

    p2.then(function(rawData) {

      // console.log("seeing if this wokrs: ", data, dataFetcher.formatData(data));
      ...
      function updateData() {
        ...
        $scope.mapData = data[index];
        // $scope.mapData2 = data[index];
        $scope.yearMonth = "hello";
